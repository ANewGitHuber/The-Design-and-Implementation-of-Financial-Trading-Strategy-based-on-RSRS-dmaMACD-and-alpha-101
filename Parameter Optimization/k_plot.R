...
rm(list = ls())
setwd("/Users/zyx/backtester_v5.7/DATA/PART1")
price <- as.xts(read.zoo("01.csv",header=TRUE,sep=",",colClasses = c("Date", rep("numeric",5))))
...
data <- read.csv("/Users/zyx/backtester_v5.7/DATA/PART1")
data <- data[,5]
